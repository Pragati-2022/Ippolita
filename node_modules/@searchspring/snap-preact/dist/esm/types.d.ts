...
import type { ControllerConfig, SearchControllerConfig, AutocompleteControllerConfig, FinderControllerConfig, RecommendationControllerConfig, ContextVariables } from '@searchspring/snap-controller';
...
declare type UrlParameterConfig<Type> = {
...
export declare type InitialUrlConfig = {
    settings?: {
        ignoreParameters?: string[];
...
export declare type SnapControllerConfig = {
